...
public class Alquiler {
    ...
    public Alquiler( int posAmarre,Barco barco,Cliente cliente, int cantDias){
        this.barco=barco;
        this.cliente=cliente;
        this.posAmarre=posAmarre;
         LocalDate today = LocalDate.now();
      
        LocalDate dias = today.plusDays(cantDias);
       DateTimeFormatter dtf =  DateTimeFormatter.ofPattern("yyyy/MM/dd");
        String fin = dias.format(dtf);
           String ini= today.format(dtf);
        this.fechaFin=fin;
        this.fechaIni=ini;
